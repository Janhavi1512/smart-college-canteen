...
| Menu | Cart | Receipt |
|------|------|---------|
| ![Menu](menu.png) | ![Cart](cart.png) | ![Receipt](receipt.png) |
...
│   └── js/script.js
│
└── menu.png, cart.png, receipt.png   # Screenshots used in this README
```
...
**Janhavi Govind Naik**
B.Tech Computer Technology, Yeshwantrao Chavan College of Engineering, Nagpur
[GitHub](https://github.com/Janhavi1512) | [LinkedIn](https://www.linkedin.com/in/janhavi-naik99)
